  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
        ...
        <span>/</span>
        <span className="cursor-pointer hover:text-blue-600">Receiver</span>
        <span>/</span>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
        <h2 className="text-2xl font-semibold text-gray-800">List Receiver</h2>
        <button
          onClick={() => navigate("/receivercreate")}
            ...
            {receivers.length > 0 ? (
              receivers.map((receiver, index) => (
                ...
                >
                  ...
                  <td className="py-3 px-4 text-gray-700">{receiver.branch}</td>
                  <td className="py-3 px-4 text-gray-700">{receiver.email}</td>
                  <td className="py-3 px-4 text-gray-700">{receiver.contact}</td>
                </tr>
              ))
            ) : (
              <tr>
                ...
                >
                  No receivers found. Click “Add New” to create one.
                </td>
              </tr>
            )}
          </tbody>
