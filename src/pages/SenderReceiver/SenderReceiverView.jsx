  ...
  /* ---------------- Skeleton helpers ---------------- */
  const Skel = ({ className = "", w = "100%", h = 12 }) => (
    <div
    ...
    useEffect(() => {
      ...
      (async () => {
        try {
          ...
          setPage(1); // reset to first page on new query/filter
        } catch {
          if (!mounted) return;
          ...
          <table className="min-w-full bg-white rounded-lg">
            ...
            <tbody>
              {loading ? (
                ...
                pagedRows.map((p, idx) => {
                  const absoluteIndex = (page - 1) * perPage + idx; // for serial number
                  ...
                  return (
                    ...
                    >
                      <td className="py-3 px-4 text-gray-700">{absoluteIndex + 1}</td>
